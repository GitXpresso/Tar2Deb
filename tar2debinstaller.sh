...
v1.0.0() {
  read -p "Do you want to remove 'tar2deb-1.0.0.deb'? (yes/no): " yesorno
  if [ "$yesorno" = "yes" ]; then
...
v1.0.1() {
  read -p "Do you want to remove 'tar2deb-1.0.1.deb'? (yes/no): " yesorno
  if [ "$yesorno" = "yes" ]; then
...
v1.0.2() {
  read -p "Do you want to remove 'tar2deb-1.0.2.deb'? (yes/no): " yesorno
  if [ "$yesorno" = "yes" ]; then
